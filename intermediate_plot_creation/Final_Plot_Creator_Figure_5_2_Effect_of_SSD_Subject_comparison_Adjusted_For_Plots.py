...
for subject_id in [1, 2]:
	...
	axes[i, subject_id - 1].plot(np.arange(-500, 500), hfsep_around_artifact_mean_ten[:,3], label='single-trial example', color='red', linewidth=0.75)
	...
	axes[i, subject_id - 1].set_ylim([-0.5, 0.5])
	...
	axes[i, subject_id - 1].set_ylim([-0.1, 0.1])
...
plt.savefig('/home/christoph/Desktop/Pictures_for_thesis/Final_Combined_Plots/K001_vs_K002_SSD_Trial_Analysis.png', dpi=300)
