...
font.set_size(15)
ticks = np.arange(hfSEP_win[0], hfSEP_win[1])
ticklabels = ['%.1f ms' % tick for tick in ((ticks) / 10)]
...
plt.pcolormesh(meet.epochEEG(kx_data_combined, triggers_for_kx_combined, hfSEP_win)[5] - meet.epochEEG(kx_data_combined, triggers_for_kx_combined, hfSEP_win)[0])
plt.colorbar()
plt.xlabel('Sample', fontrpoperties=font)
plt.ylabel('Relative time in Sample', fontrpoperties=font)
plt.title('Visualization of epoched [70, 470] raw data of K00%d' % (idx + 1), fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
#plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/000_k00%d_raw_data_colormesh.png' % (idx + 1, idx + 1))
#plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
plt.xticks(ticks=ticks, labels=ticklabels)
fig.suptitle('Visualization of epoched [%d, %d] raw data of K00%d and the average hfSEP in CP5-FZ' % (hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
fig.tight_layout(rect=[0, 0.03, 1, 0.95])
#plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/001_k00%d_raw_data_cp5-fz_colormesh.png' % (idx + 1, idx + 1))
#plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
fig.suptitle('Visualization of interpolated [%d, %d], epoched [%d, %d], bandpass-filtered fp=[500, 900] data of K00%d and the average hfSEP in CP5-FZ' % (intrplt_win[0], intrplt_win[1], hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
fig.tight_layout(rect=[0, 0.03, 1, 0.95])
#plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/002_k00%d_intrplt_filt_500_900_data_cp5-fz_colormesh.png' % (idx + 1, idx + 1))
#plt.close('all')

s_eigvals, t_eigvals, W, V = bCSTP(epchd_intrplt_500_900_hfsep[:8], epchd_intrplt_500_900_noise[:8], num_iter=1, t_keep=1, s_keep=1)
data_WVfilt = scipy.ndimage.convolve1d(np.dot(W[-1][:,0], intrplt_filt_500_900[:8]), V[-1][:,0][::-1], axis=-1)
WVtrials = meet.epochEEG(data_WVfilt, triggers_for_kx_combined, [100, 400])

#00_ToDo worked on temporal and spatial filter eigenvalues
plt.figure(figsize=(18,9))
plt.plot(s_eigvals[-1])
plt.xlabel('Relative filter', fontrpoperties=font)
plt.ylabel('Eigenvalue of relative filter', fontrpoperties=font)
plt.title('Visualization of Eigenvalues of the <<spatial-fitler-to-be-applied>> for data of K00%d' % idx + 1, fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/003_k00%d_spat_bcstp_filt_eigenvals.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Relative filter', fontrpoperties=font)
plt.ylabel('Eigenvalue of relative filter', fontrpoperties=font)
plt.title('Visualization of Eigenvalues of the <<temporal-fitler-to-be-applied>> for data of K00%d' % idx + 1, fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/004_k00%d_temp_bcstp_filt_eigenvals.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('From Filter expected value in Sample', fontrpoperties=font)
plt.title('Visualization of pseudo-inverse of <<temporal-fitler-to-be-applied>> for data of K00%d' % idx + 1, fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/005_k00%d_pinv_of_temp_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.plot(
    meet.epochEEG(
        np.dot(
            W[-1][:,0], 
            meet.iir.butterworth(
                meet.basic.interpolateEEG(
                    kx_data_combined[:8], triggers_for_kx_combined, [-170, 70]
                ), 
            fp=[500, 900], fs=[450, 1000], s_rate=10000)
        ), triggers_for_kx_combined, [70, 470]
    ).mean(-1)
)
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
plt.title('Visualization of mean-hfSEP after applying spatial filter of bCSTP to interpolated [%d, %d], epoched [%d, %d], bandpass-filtered fp=[500, 900] data of K00%d' % (intrplt_win[0], intrplt_win[1], hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/006_k00%d_bcstp_spat_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
plt.title('Visualization of mean-hfSEP after applying bCSTP to interpolated [%d, %d], epoched [%d, %d], bandpass-filtered fp=[500, 900] data of K00%d' % (intrplt_win[0], intrplt_win[1], hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/007_k00%d_bcstp_spat_temp_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Sample', fontrpoperties=font)
plt.ylabel('Relative time in Sample', fontrpoperties=font)
plt.title('Visualization of epoched [%d, %d] data of K00%d after applying spatial and temporal filters of bCSTP' % (hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/008_k00%d_colormesh_bcstp_spat_temp_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.pcolormesh(
    meet.epochEEG(
        ...
        , V[-1][:,0][::-1], axis=-1)
    , triggers_for_kx_combined, [70, 470])**2
)
plt.colorbar()
plt.xlabel('Sample', fontrpoperties=font)
plt.ylabel('Relative time in Sample', fontrpoperties=font)
plt.title('Visualization of epoched [%d, %d] data of K00%d after applying spatial and temporal filters of bCSTP' % (hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
plt.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/009_k00%d_colormesh_squared_bcstp_spat_temp_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
fig.suptitle('Visualization of mean-hfSEP after applying spatial filter of bCSTP to interpolated [%d, %d], epoched [%d, %d], bandpass-filtered fp=[500, 900] data of K00%d' % (intrplt_win[0], intrplt_win[1], hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
fig.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/010_k00%d_colormesh_bcstp_spat_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
fig.suptitle('Visualization of epoched [%d, %d] data of K00%d after applying spatial and temporal filters of bCSTP' % (hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
fig.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/011_k00%d_colormesh_bcstp_temp_spat_filt.png' % (idx + 1, idx + 1))
plt.close('all')
...
plt.xlabel('Relative time in Sample', fontrpoperties=font)
plt.ylabel('Average signal', fontrpoperties=font)
fig.suptitle('Visualization of squared epoched [%d, %d] data of K00%d after applying spatial and temporal filters of bCSTP' % (hfSEP_win[0], hfSEP_win[1], idx + 1), fontrpoperties=font)
fig.tight_layout(rect=[0, 0.03, 1, 0.95])
plt.savefig('/home/christoph/Desktop/Meeting_Gunnar_24_09/Meeting_25_09/Meeting_Monday/test_script/k00%d/012_k00%d_colormesh_squared_bcstp_temp_spat_filt.png' % (idx + 1, idx + 1))
plt.close('all')

#plt.pcolormesh((WVtrials**2), vmax=0.003)
#plt.colorbar()
#plt.figure(figsize=(18,9))
