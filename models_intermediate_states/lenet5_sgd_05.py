...
model.save('/media/christoph/Volume/Masterthesis/models_trained_and_saved_test_place/le_net_5_sgd_05')
np.save('/media/christoph/Volume/Masterthesis/histories_of_models_trained_and_saved_test_place/le_net_5_sgd_05', history.history)
