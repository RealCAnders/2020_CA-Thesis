...
for data, labels, run_title in workload:
  ...
  model.save('/media/christoph/Volume/Masterthesis/multi-channel-training/eeg_net/models/%d/eeg_net_on_%s' % (idx, run_title.replace('/', '-')))
  np.save('/media/christoph/Volume/Masterthesis/multi-channel-training/eeg_net/history/%d/eeg_net_on_%s' % (idx, run_title.replace('/', '-')), history.history)
  ...
  np.save('/media/christoph/Volume/Masterthesis/multi-channel-training/eeg_net/%d/eeg_net_on_%s_confusion_matrix' % (idx, run_title.replace('/', '-')), confusion_matrix_for_model)

  metrics = metrics_for_conf_mat(tn, fp, fn, tp)
  np.save('/media/christoph/Volume/Masterthesis/multi-channel-training/eeg_net/%d/eeg_net_on_%s_metrics' % (idx, run_title.replace('/', '-')), metrics)