...
model.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/dense_conv_net/models_trained_and_saved_test_place/%s/dense_conv_net_w_%s_lr_%f_clip_%s_k00%d_on_csp' % (title, 'sgd', 0.001, 'True', k))
np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/dense_conv_net/histories_of_models_trained_and_saved_test_place/%s/dense_conv_net_w_%s_lr_%f_clip_%s_k00%d_on_csp' % (title, 'sgd', 0.001, 'True', k), history.history)
...
np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/dense_conv_net/histories_of_models_trained_and_saved_test_place_confusion_matrices/%s/dense_conv_net_w_sgd_lr_0001_clip_True_k00%d_tn_%d_fp_%d_fn_%d_tp_%d_on_csp_confusion_matrix' % (title, k, tn, fp, fn, tp), confusion_matrix_for_model)

metrics = metrics_for_conf_mat(tn, fp, fn, tp)
np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/dense_conv_net/histories_of_models_trained_and_saved_test_place_confusion_matrices/%s/dense_conv_net_w_sgd_lr_0001_clip_True_k00%d_tn_%d_fp_%d_fn_%d_tp_%d_on_csp_metrics' % (title, k, tn, fp, fn, tp), metrics)