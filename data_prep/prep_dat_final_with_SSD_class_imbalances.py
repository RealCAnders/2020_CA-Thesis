...
#  return np.repeat(np.asarray(triggers_to_get_indices_for), 10) + np.random.choice(possible_noise_indices_per_sample, len(triggers_to_get_indices_for) * 10)
...
### ### ### ### ###
hfSEP_win = [100, 350]
noise_win = [0, 250] # due to shifted noise-point identification we can start w. rel index 0 to where the random-trigger will be  
intrplt_win = [-80, 30]

print('Running script with corrected SSD and settings to save only the full data as well as the trigger-points, in order to later compute as many noise-windows as needed')
...
def prep_without_outlier_rejection():
  ...
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_kx_data_combined' % (idx + 1), csp_filt_epoched_kx_data_combined)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_intrplt_kx_data_combined' % (idx + 1), csp_filt_epoched_intrplt_kx_data_combined)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_intrplt_filt_under_100_kx' % (idx + 1), csp_filt_epoched_intrplt_filt_under_100_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_intrplt_filt_over_100_kx' % (idx + 1), csp_filt_epoched_intrplt_filt_over_100_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_intrplt_filt_over_400_kx' % (idx + 1), csp_filt_epoched_intrplt_filt_over_400_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_intrplt_filt_500_900_kx' % (idx + 1), csp_filt_epoched_intrplt_filt_500_900_kx)
...
#-#  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/csp_filt_epoched_intrplt_filt_500_900_kx_noise' % (idx + 1), csp_filt_epoched_intrplt_filt_500_900_kx_noise)
  ...
  ssd_intrplt_filt_under_100_kx_filters, ssd_intrplt_filt_under_100_kx_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_under_100_kx_hfsep[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep[:8].reshape(8, -1))
  ssd_intrplt_filt_over_100_kx_filters, ssd_intrplt_filt_over_100_kx_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_over_100_kx_hfsep[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep[:8].reshape(8, -1))
  ssd_intrplt_filt_over_400_kx_filters, ssd_intrplt_filt_over_400_kx_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_over_400_kx_hfsep[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep[:8].reshape(8, -1))
  ...
  ssd_filt_intrplt_filt_under_100_kx = np.tensordot(ssd_intrplt_filt_under_100_kx_filters[:,0].T, intrplt_filt_under_100_kx[:8], axes=(0, 0))
  ssd_filt_intrplt_filt_over_100_kx = np.tensordot(ssd_intrplt_filt_over_100_kx_filters[:,0].T, intrplt_filt_over_100_kx[:8], axes=(0, 0))
  ssd_filt_intrplt_filt_over_400_kx = np.tensordot(ssd_intrplt_filt_over_400_kx_filters[:,0].T, intrplt_filt_over_400_kx[:8], axes=(0, 0))
  ...
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_over_400_kx' % (idx + 1), ssd_filt_intrplt_filt_over_400_kx)
...
#-#  ssd_filt_intrplt_filt_under_100_kx_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_under_100_kx, triggers_for_kx_combined, hfSEP_win)
#-#  ssd_filt_intrplt_filt_over_100_kx_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_over_100_kx, triggers_for_kx_combined, hfSEP_win)
#-#  ssd_filt_intrplt_filt_over_400_kx_kx_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_over_400_kx, triggers_for_kx_combined, hfSEP_win)
#-#  ssd_filt_intrplt_filt_500_900_kx_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_500_900_kx, triggers_for_kx_combined, hfSEP_win)
#-#
#-#  ssd_filt_intrplt_filt_under_100_kx_noise = meet.epochEEG(ssd_filt_intrplt_filt_under_100_kx, get_indices_for_noise(triggers_for_kx_combined), noise_win)
#-#  ssd_filt_intrplt_filt_over_100_kx_noise = meet.epochEEG(ssd_filt_intrplt_filt_over_100_kx, get_indices_for_noise(triggers_for_kx_combined), noise_win)
#-#  ssd_filt_intrplt_filt_over_400_kx_kx_noise = meet.epochEEG(ssd_filt_intrplt_filt_over_400_kx, get_indices_for_noise(triggers_for_kx_combined), noise_win)
#-#  ssd_filt_intrplt_filt_500_900_kx_noise = meet.epochEEG(ssd_filt_intrplt_filt_500_900_kx, get_indices_for_noise(triggers_for_kx_combined), noise_win)

  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_under_100_kx_hfsep' % (idx + 1), ssd_filt_intrplt_filt_under_100_kx_hfsep)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_over_100_kx_hfsep' % (idx + 1), ssd_filt_intrplt_filt_over_100_kx_hfsep)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_over_400_kx_hfsep' % (idx + 1), ssd_filt_intrplt_filt_over_400_kx_kx_hfsep)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_500_900_kx_hfsep' % (idx + 1), ssd_filt_intrplt_filt_500_900_kx_hfsep)

  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_under_100_kx_noise' % (idx + 1), ssd_filt_intrplt_filt_under_100_kx_noise)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_over_100_kx_noise' % (idx + 1), ssd_filt_intrplt_filt_over_100_kx_noise)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_over_400_kx_noise' % (idx + 1), ssd_filt_intrplt_filt_over_400_kx_kx_noise)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ssd_filt_intrplt_filt_500_900_kx_noise' % (idx + 1), ssd_filt_intrplt_filt_500_900_kx_noise)
  ...
  ccar_filt_kx_data_combined = np.tensordot(a_epoched_kx_data_combined_hfsep[:,0], kx_data_combined[:8,:], axes=(0, 0))
  ccar_filt_intrplt_kx_data_combined = np.tensordot(a_epoched_intrplt_kx_data_combined_hfsep[:,0], intrplt_kx_data_combined[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_under_100_kx = np.tensordot(a_epoched_intrplt_filt_under_100_kx_hfsep[:,0], intrplt_filt_under_100_kx[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_over_100_kx = np.tensordot(a_epoched_intrplt_filt_over_100_kx_hfsep[:,0], intrplt_filt_over_100_kx[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_over_400_kx = np.tensordot(a_epoched_intrplt_filt_over_400_kx_hfsep[:,0], intrplt_filt_over_400_kx[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_500_900_kx = np.tensordot(a_epoched_intrplt_filt_500_900_kx_hfsep[:,0], intrplt_filt_500_900_kx[:8,:], axes=(0, 0))

  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ccar_filt_kx_data_combined' % (idx + 1), ccar_filt_kx_data_combined)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ccar_filt_intrplt_kx_data_combined' % (idx + 1), ccar_filt_intrplt_kx_data_combined)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ccar_filt_intrplt_filt_under_100_kx' % (idx + 1), ccar_filt_intrplt_filt_under_100_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ccar_filt_intrplt_filt_over_100_kx' % (idx + 1), ccar_filt_intrplt_filt_over_100_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ccar_filt_intrplt_filt_over_400_kx' % (idx + 1), ccar_filt_intrplt_filt_over_400_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/ccar_filt_intrplt_filt_500_900_kx' % (idx + 1), ccar_filt_intrplt_filt_500_900_kx)
...
#-#  ccar_filt_epoched_intrplt_filt_500_900_kx_noise = np.tensordot(a_epoched_intrplt_filt_500_900_kx_hfsep[:,0], epoched_intrplt_filt_500_900_kx_noise[:8,:,:], axes=(0, 0))
  ...
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/bcstp_spat_temp_filt_intrplt_kx_data_combined' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_kx_data_combined)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/bcstp_spat_temp_filt_intrplt_filt_under_100_kx' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_under_100_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/bcstp_spat_temp_filt_intrplt_filt_over_100_kx' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_over_100_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/bcstp_spat_temp_filt_intrplt_filt_over_400_kx' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_over_400_kx)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped/k00%d/bcstp_spat_temp_filt_intrplt_filt_500_900_kx' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_500_900_kx)
...
def prep_with_outlier_rejection():
  ...
  # CSP is the signal decomposition using two different signal modalities, due to different points in time, but same preprocessing
  csp_epoched_intrplt_kx_data_combined_hfsep_filters_out_rej, csp_epoched_intrplt_kx_data_combined_hfsep_eigenvals_out_rej = meet.spatfilt.CSP(epoched_intrplt_kx_data_combined_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_noise_out_rej[:8].reshape(8, -1))
  csp_epoched_intrplt_filt_under_100_kx_filters_out_rej, csp_epoched_intrplt_filt_under_100_kx_eigenvals_out_rej = meet.spatfilt.CSP(epoched_intrplt_filt_under_100_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_filt_under_100_kx_noise_out_rej[:8].reshape(8, -1))
  csp_epoched_intrplt_filt_over_100_kx_filters_out_rej, csp_epoched_intrplt_filt_over_100_kx_eigenvals_out_rej = meet.spatfilt.CSP(epoched_intrplt_filt_over_100_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_filt_over_100_kx_noise_out_rej[:8].reshape(8, -1))
  csp_epoched_intrplt_filt_over_400_kx_filters_out_rej, csp_epoched_intrplt_filt_over_400_kx_eigenvals_out_rej = meet.spatfilt.CSP(epoched_intrplt_filt_over_400_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_filt_over_400_kx_noise_out_rej[:8].reshape(8, -1))
  csp_epoched_intrplt_filt_500_900_kx_filters_out_rej, csp_epoched_intrplt_filt_500_900_kx_eigenvals_out_rej = meet.spatfilt.CSP(epoched_intrplt_filt_500_900_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_filt_500_900_kx_noise_out_rej[:8].reshape(8, -1))
  ...
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/csp_filt_intrplt_kx_data_combined_out_rej' % (idx + 1), csp_filt_epoched_intrplt_kx_data_combined_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/csp_filt_intrplt_filt_under_100_kx_out_rej' % (idx + 1), csp_filt_epoched_intrplt_filt_under_100_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/csp_filt_intrplt_filt_over_100_kx_out_rej' % (idx + 1), csp_filt_epoched_intrplt_filt_over_100_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/csp_filt_intrplt_filt_over_400_kx_out_rej' % (idx + 1), csp_filt_epoched_intrplt_filt_over_400_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/csp_filt_intrplt_filt_500_900_kx_out_rej' % (idx + 1), csp_filt_epoched_intrplt_filt_500_900_kx_out_rej)
...
#-#  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/csp_filt_epoched_intrplt_filt_500_900_kx_noise_out_rej' % (idx + 1), csp_filt_epoched_intrplt_filt_500_900_kx_noise_out_rej)
  ...
  # SSD is the signal decomposition using two different frequency-filtered datasets as different conditions
  ssd_intrplt_filt_under_100_kx_out_rej_filters, ssd_intrplt_filt_under_100_kx_out_rej_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_under_100_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep_out_rej[:8].reshape(8, -1))
  ssd_intrplt_filt_over_100_kx_out_rej_filters, ssd_intrplt_filt_over_100_kx_out_rej_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_over_100_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep_out_rej[:8].reshape(8, -1))
  ssd_intrplt_filt_over_400_kx_out_rej_filters, ssd_intrplt_filt_over_400_kx_out_rej_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_over_400_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep_out_rej[:8].reshape(8, -1))
  ssd_intrplt_filt_500_900_kx_out_rej_filters, ssd_intrplt_filt_500_900_kx_out_rej_eigenvals = meet.spatfilt.CSP(epoched_intrplt_filt_500_900_kx_hfsep_out_rej[:8].reshape(8, -1), epoched_intrplt_kx_data_combined_hfsep_out_rej[:8].reshape(8, -1))

  ssd_filt_intrplt_filt_under_100_kx_out_rej = np.tensordot(ssd_intrplt_filt_under_100_kx_out_rej_filters[:,0].T, intrplt_filt_under_100_kx_out_rej[:8], axes=(0, 0))
  ssd_filt_intrplt_filt_over_100_kx_out_rej = np.tensordot(ssd_intrplt_filt_over_100_kx_out_rej_filters[:,0].T, intrplt_filt_over_100_kx_out_rej[:8], axes=(0, 0))
  ssd_filt_intrplt_filt_over_400_kx_kx_out_rej = np.tensordot(ssd_intrplt_filt_over_400_kx_out_rej_filters[:,0].T, intrplt_filt_over_400_kx_out_rej[:8], axes=(0, 0))
  ssd_filt_intrplt_filt_500_900_kx_out_rej = np.tensordot(ssd_intrplt_filt_500_900_kx_out_rej_filters[:,0].T, intrplt_filt_500_900_kx_out_rej[:8], axes=(0, 0))
...
#-#  ssd_filt_intrplt_filt_under_100_kx_out_rej_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_under_100_kx_out_rej, triggers_identified_after_rejection_under_100_kx_out_rej, hfSEP_win)
#-#  ssd_filt_intrplt_filt_over_100_kx_out_rej_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_over_100_kx_out_rej, triggers_identified_after_rejection_over_100_kx_out_rej, hfSEP_win)
#-#  ssd_filt_intrplt_filt_over_400_kx_kx_out_rej_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_over_400_kx_kx_out_rej, triggers_identified_after_rejection_over_400_kx_out_rej, hfSEP_win)
#-#  ssd_filt_intrplt_filt_500_900_kx_out_rej_hfsep = meet.epochEEG(ssd_filt_intrplt_filt_500_900_kx_out_rej, triggers_identified_after_rejection_500_900_kx_out_rej, hfSEP_win)
#-#
#-#  ssd_filt_intrplt_filt_under_100_kx_out_rej_noise = meet.epochEEG(ssd_filt_intrplt_filt_under_100_kx_out_rej, get_indices_for_noise(triggers_identified_after_rejection_under_100_kx_out_rej), noise_win)
#-#  ssd_filt_intrplt_filt_over_100_kx_out_rej_noise = meet.epochEEG(ssd_filt_intrplt_filt_over_100_kx_out_rej, get_indices_for_noise(triggers_identified_after_rejection_over_100_kx_out_rej), noise_win)
#-#  ssd_filt_intrplt_filt_over_400_kx_kx_out_rej_noise = meet.epochEEG(ssd_filt_intrplt_filt_over_400_kx_kx_out_rej, get_indices_for_noise(triggers_identified_after_rejection_over_400_kx_out_rej), noise_win)
#-#  ssd_filt_intrplt_filt_500_900_kx_out_rej_noise = meet.epochEEG(ssd_filt_intrplt_filt_500_900_kx_out_rej, get_indices_for_noise(triggers_identified_after_rejection_500_900_kx_out_rej), noise_win)

  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_under_100_kx_out_rej_hfsep' % (idx + 1), ssd_filt_intrplt_filt_under_100_kx_out_rej_hfsep)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_over_100_kx_out_rej_hfsep' % (idx + 1), ssd_filt_intrplt_filt_over_100_kx_out_rej_hfsep)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_over_400_kx_out_rej_hfsep' % (idx + 1), ssd_filt_intrplt_filt_over_400_kx_kx_out_rej_hfsep)
  #save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_500_900_kx_out_rej_hfsep' % (idx + 1), ssd_filt_intrplt_filt_500_900_kx_out_rej_hfsep)

#-#  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_under_100_kx_out_rej_noise' % (idx + 1), ssd_filt_intrplt_filt_under_100_kx_out_rej_noise)
#-#  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_over_100_kx_out_rej_noise' % (idx + 1), ssd_filt_intrplt_filt_over_100_kx_out_rej_noise)
#-#  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_over_400_kx_out_rej_noise' % (idx + 1), ssd_filt_intrplt_filt_over_400_kx_kx_out_rej_noise)
#-#  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ssd_filt_intrplt_filt_500_900_kx_out_rej_noise' % (idx + 1), ssd_filt_intrplt_filt_500_900_kx_out_rej_noise)
  ...
  ccar_filt_intrplt_kx_data_combined_out_rej = np.tensordot(a_epoched_intrplt_kx_data_combined_hfsep_out_rej[:,0], kx_data_intrplt_outliers_rejected[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_under_100_kx_out_rej = np.tensordot(a_epoched_intrplt_filt_under_100_kx_hfsep_out_rej[:,0], intrplt_filt_under_100_kx_out_rej[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_over_100_kx_out_rej = np.tensordot(a_epoched_intrplt_filt_over_100_kx_hfsep_out_rej[:,0], intrplt_filt_over_100_kx_out_rej[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_over_400_kx_out_rej = np.tensordot(a_epoched_intrplt_filt_over_400_kx_hfsep_out_rej[:,0], intrplt_filt_over_400_kx_out_rej[:8,:], axes=(0, 0))
  ccar_filt_intrplt_filt_500_900_kx_out_rej = np.tensordot(a_epoched_intrplt_filt_500_900_kx_hfsep_out_rej[:,0], intrplt_filt_500_900_kx_out_rej[:8,:], axes=(0, 0))

  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ccar_filt_intrplt_kx_data_combined_out_rej' % (idx + 1), ccar_filt_intrplt_kx_data_combined_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ccar_filt_intrplt_filt_under_100_kx_out_rej' % (idx + 1), ccar_filt_intrplt_filt_under_100_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ccar_filt_intrplt_filt_over_100_kx_out_rej' % (idx + 1), ccar_filt_intrplt_filt_over_100_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ccar_filt_intrplt_filt_over_400_kx_out_rej' % (idx + 1), ccar_filt_intrplt_filt_over_400_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/ccar_filt_intrplt_filt_500_900_kx_out_rej' % (idx + 1), ccar_filt_intrplt_filt_500_900_kx_out_rej)
...
#-#  ccar_filt_epoched_intrplt_filt_500_900_kx_noise_out_rej = np.tensordot(a_epoched_intrplt_filt_500_900_kx_hfsep_out_rej[:,0], epoched_intrplt_filt_500_900_kx_noise_out_rej[:8,:,:], axes=(0, 0))
  ...
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/bcstp_spat_temp_filt_intrplt_filt_under_100_kx_out_rej' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_under_100_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/bcstp_spat_temp_filt_intrplt_filt_over_100_kx_out_rej' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_over_100_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/bcstp_spat_temp_filt_intrplt_filt_over_400_kx_out_rej' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_over_400_kx_out_rej)
  save('/media/christoph/Volume/Masterthesis/final_prepped_data/advanced_prepped_outliers_rejected/k00%d/bcstp_spat_temp_filt_intrplt_filt_500_900_kx_out_rej' % (idx + 1), bcstp_spat_temp_filt_epoched_intrplt_filt_500_900_kx_out_rej)
