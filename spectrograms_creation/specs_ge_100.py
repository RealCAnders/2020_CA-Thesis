...
one_sec_win = [0, 10000]                                                                                                                                                             
one_sec_samples_of_ccar_filt_k003 = meet.epochEEG(intrplt_filt_over_100_kx[0] - intrplt_filt_over_100_kx[5], np.arange(0, 1300000, 10000), one_sec_win)
...
extension_avg = '5_s%dspec%s500avg'
...
plt.ylim([0, 1400])                                                                                                                                                               
plt.tick_params(labelsize=20)
extension_st = '4_s%dspec%ssingletrial'
