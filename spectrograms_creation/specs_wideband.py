...
one_sec_win = [0, 10000]                                                                                                                                                             
one_sec_samples_of_ccar_filt_k003 = meet.epochEEG(data_k3_combined[0] - data_k3_combined[5], np.arange(0, 1300000, 10000), one_sec_win)
...
plt.pcolormesh(t_range, f_range, 20 * np.log10(mean_spectrogram), cmap=plt.cm.plasma, vmin=1, vmax=5)                                                                                                         
bar = plt.colorbar()                                                                                                                                                                
...
plt.pcolormesh(t_range, f_range, 20 * np.log10(single_trial_spec), cmap=plt.cm.plasma, vmin=1, vmax=5)
bar = plt.colorbar()                                                                                                                                                                
bar.set_label('amplitude', fontsize=20)
bar.ax.tick_params(labelsize=20)
