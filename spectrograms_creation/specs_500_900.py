...
one_sec_win = [0, 10000]                                                                                                                                                             
one_sec_samples_of_ccar_filt_k003 = meet.epochEEG(intrplt_filt_500_900_kx[0] - intrplt_filt_500_900_kx[5], np.arange(0, 1300000, 10000), one_sec_win)
...
plt.pcolormesh(t_range, f_range, 20 * np.log10(mean_spectrogram), cmap=plt.cm.plasma, vmin=0, vmax=3)                                                                                                          
bar = plt.colorbar()                                                                                                                                                                
...
extension_avg = '9_s%dspec%s500avg'
...
plt.pcolormesh(t_range, f_range, 20 * np.log10(single_trial_spec), cmap=plt.cm.plasma, vmin=0, vmax=3)
bar = plt.colorbar()                                                                                                                                                                
bar.set_label('amplitude', fontsize=20)
bar.ax.tick_params(labelsize=20)
...
plt.ylim([0, 1400])                                                                                                                                                               
plt.tick_params(labelsize=20)
extension_st = '8_s%dspec%ssingletrial'
