  ...
  for data, labels, run_title in workload:
    ...
    if idx <= -1:
      ...
      for model_tuple in models:
        ...
        model.save('/media/christoph/Volume/Masterthesis/UCR_TSC/scripts_and_results/2d_tsc_rec_plots/%s/models/%s_on_%s' % (model_tuple[1], model_tuple[1], run_title.replace('/', '-')))
        np.save('/media/christoph/Volume/Masterthesis/UCR_TSC/scripts_and_results/2d_tsc_rec_plots/%s/histories/%s_on_%s' % (model_tuple[1], model_tuple[1], run_title.replace('/', '-')), history.history)
        ...
        np.save('/media/christoph/Volume/Masterthesis/UCR_TSC/scripts_and_results/2d_tsc_rec_plots/%s/metrics/%s_on_%s_confusion_matrix' % (model_tuple[1], model_tuple[1], run_title.replace('/', '-')), confusion_matrix_for_model)
      
        metrics = metrics_for_conf_mat(tn, fp, fn, tp)
        np.save('/media/christoph/Volume/Masterthesis/UCR_TSC/scripts_and_results/2d_tsc_rec_plots/%s/metrics/%s_on_%s_metrics' % (model_tuple[1], model_tuple[1], run_title.replace('/', '-')), metrics)
