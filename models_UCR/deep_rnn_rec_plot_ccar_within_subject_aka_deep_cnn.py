...
### Runs correctly, but It ran already. No need to run again.
...
#-#
#-#        model.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/models_trained_and_saved_test_place/%s/deep_cnn_w_%s_lr_%f_clip_%s_k00%d_on_ccar' % (title, 'sgd', 0.001, 'True', k))
#-#        np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/histories_of_models_trained_and_saved_test_place/%s/deep_cnn_w_%s_lr_%f_clip_%s_k00%d_on_ccar' % (title, 'sgd', 0.001, 'True', k), history.history)
#-#
...
#-#        np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/histories_of_models_trained_and_saved_test_place_confusion_matrices/%s/deep_cnn_w_sgd_lr_0001_clip_True_k00%d_tn_%d_fp_%d_fn_%d_tp_%d_on_ccar_confusion_matrix' % (title, k, tn, fp, fn, tp), confusion_matrix_for_model)
#-#
#-#        metrics = metrics_for_conf_mat(tn, fp, fn, tp)
#-#        np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/histories_of_models_trained_and_saved_test_place_confusion_matrices/%s/deep_cnn_w_sgd_lr_0001_clip_True_k00%d_tn_%d_fp_%d_fn_%d_tp_%d_on_ccar_metrics' % (title, k, tn, fp, fn, tp), metrics)

# Ran through parts already then I stopped it due to confusion
#-#-#for title in ['epoched_intrplt_kx_data_combined',
#-#-#    'epoched_intrplt_filt_under_100_kx',
#-#-#    'epoched_intrplt_filt_over_100_kx',
#-#-#    'epoched_intrplt_filt_over_400_kx',
...
for title in ['epoched_intrplt_filt_over_400_kx',
    'epoched_intrplt_filt_500_900_kx']:
    for k in range(1, 11): 
        ...
        model.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/models_trained_and_saved_test_place/%s/deep_cnn_w_%s_lr_%f_clip_%s_k00%d_on_csp' % (title, 'sgd', 0.001, 'True', k))
        np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/histories_of_models_trained_and_saved_test_place/%s/deep_cnn_w_%s_lr_%f_clip_%s_k00%d_on_csp' % (title, 'sgd', 0.001, 'True', k), history.history)

        predictions = np.abs(np.rint(model.predict(x=X_test)))
        confusion_matrix_for_model = confusion_matrix(y_test, predictions)
        tn, fp, fn, tp = confusion_matrix_for_model.ravel()
        np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/histories_of_models_trained_and_saved_test_place_confusion_matrices/%s/deep_cnn_w_sgd_lr_0001_clip_True_k00%d_tn_%d_fp_%d_fn_%d_tp_%d_on_csp_confusion_matrix' % (title, k, tn, fp, fn, tp), confusion_matrix_for_model)

        metrics = metrics_for_conf_mat(tn, fp, fn, tp)
        np.save('/media/christoph/Volume/Masterthesis/recurrence_plot_training/within_subject/histories_of_models_trained_and_saved_test_place_confusion_matrices/%s/deep_cnn_w_sgd_lr_0001_clip_True_k00%d_tn_%d_fp_%d_fn_%d_tp_%d_on_csp_metrics' % (title, k, tn, fp, fn, tp), metrics)